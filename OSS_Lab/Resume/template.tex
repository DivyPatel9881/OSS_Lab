...
\cvname{Divy} % Your name
\cvjobtitle{Patel} % Job title/career

\cvdate{29 May 2000} % Date of birth
\cvaddress{divy9881@gmail.com} % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{+91 8169662029} % Phone number
...
\Education{B.Tech Information Technology Engineering VJTI | 2021 | CGPA:9.25/10
\newline \newline Class XII \newline  BNN Jr College | 2017 | 87 \%
\newline \newline Class X \newline  Scholar's School | 2015 | 92 \%} % To have no Education section, just remove all the text and leave \Education{}
...
\skills{Languages:Python, JavaScript, Java, C++/C, Go
\newline  WebDev : HTML, CSS, JS, JQuery, php, SASS
